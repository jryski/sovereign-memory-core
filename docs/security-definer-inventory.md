...
`sql/09_perimeter_refresh.sql`, and `sql/11_topology_scope.sql`: 29 `SECURITY DEFINER` routines and 20 helpers
...
`tests/10_security_definer_temp_shadow.sql` compares the installed 29-routine
